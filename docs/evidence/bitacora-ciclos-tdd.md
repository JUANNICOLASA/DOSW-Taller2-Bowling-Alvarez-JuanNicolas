...
Cada fase **RED** se verificó ejecutando las pruebas *antes* de escribir el
código: la prueba falló en ese commit y pasó en el commit `GREEN` siguiente.

- **17** fases RED
- **20** fases GREEN
- **6** refactors
- **6** pruebas añadidas sobre código ya verde (regresión y cobertura)
...
## Merges a `develop` (Pull Requests)
